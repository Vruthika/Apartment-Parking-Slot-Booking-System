...
app.include_router(resident_routes.router2, prefix="/resident/visitors", tags=["Resident Vistiors"])
app.include_router(resident_routes.router3, prefix="/resident/request", tags=["Resident Request"])
app.include_router(resident_routes.router4, prefix="/resident/notification", tags=["Resident notifiation"])
app.include_router(resident_routes.router5, prefix="/resident/dashboard", tags=["Resident Dashboard"])
app.include_router(resident_routes.router6, prefix="/resident/unplanned", tags=["Resident unplanned"])
